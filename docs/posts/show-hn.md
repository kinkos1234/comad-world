...
Real numbers: 60K+ nodes, 150K+ relationships, $0/day additional cost (Max subscription), 2,800+ tests, every query <100ms, entity confidence scoring (0.0-1.0), built-in performance monitoring.
